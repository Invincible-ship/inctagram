...
import { POST_TAG, PROFILE_TAG, SESSION_TAG, SUBSCRIPTION_TAG, USER_TAG } from '@/shared/const/rtk'
...
export const rtkApi = createApi({
  tagTypes: [USER_TAG, PROFILE_TAG, POST_TAG, SUBSCRIPTION_TAG, SESSION_TAG],
  reducerPath: 'api',
